...
| Presentan cierta resistencia a los cambios. | Especialmente preparadas para cambios durante el proyecto. |
| Son impuestas externamente. | Son impuestas internamente (por el equipo). |
...
| Se generan más artefactos. | Se generan pocos artefactos. |
| Involucran más roles. | Involucran pocos roles. |

## Extra
- Los productos pequeños no necesitan tanto escenario.
